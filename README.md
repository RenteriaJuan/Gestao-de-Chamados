...
O desafio consiste em criar uma aplicação web, desktop e mobile de suporte tecnico e gestão de chamados con integração de IA. A aplicação deve ser capaz de analisar e atribuir a prioridade do chamado, 
